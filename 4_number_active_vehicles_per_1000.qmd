...
The number of active taxi vehicles per 1000 persons in `r end_label` was 
...
`r format(round(ytd_metric("VEHICLE_PER_1000_PERSONS","TAXI", field="value", agg="avg"), 1), nsmall = 1)`, 
`r change_phrase(metric("VEHICLE_PER_1000_PERSONS","TAXI","ytd_yoy"))` from 
`r format(round(ytd_metric("VEHICLE_PER_1000_PERSONS","TAXI", field="value", agg="avg", year_offset=-1), 1), nsmall = 1)` 
...
`r format(round(ytd_metric("VEHICLE_PER_1000_PERSONS","TNS", field="value", agg="avg"), 1), nsmall = 1)`, 
`r change_phrase(metric("VEHICLE_PER_1000_PERSONS","TNS","ytd_yoy"))` from 
`r format(round(ytd_metric("VEHICLE_PER_1000_PERSONS","TNS", field="value", agg="avg", year_offset=-1), 1), nsmall = 1)` 
over the same period (January to `r prev_label`). 
