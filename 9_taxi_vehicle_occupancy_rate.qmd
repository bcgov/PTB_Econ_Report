...
In `r region_name` Regional District, taxi vehicle occupancy rate in `r end_label` was 
`r metric("VEHICLE_OCCUPANCY_RATE","TAXI","last_value_fmt")`, 
compared with 
`r prev_metric("VEHICLE_OCCUPANCY_RATE","TAXI")` 
in `r prev_month_label`, representing 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TAXI","mom_last"))` month over month. 
`r shift_narrative("VEHICLE_OCCUPANCY_RATE","TAXI")`

On a year-over-year basis, taxi vehicle occupancy rate in `r end_label` was 
`r metric("VEHICLE_OCCUPANCY_RATE","TAXI","last_value_fmt")`, 
compared with 
`r prev_year_metric("VEHICLE_OCCUPANCY_RATE","TAXI")` 
in `r prev_label`, representing 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TAXI","yoy_last"))` year over year.

On a year-to-date basis, the average taxi vehicle occupancy rate from January to `r end_label` was 
`r format(round(ytd_metric("VEHICLE_OCCUPANCY_RATE","TAXI", field="value", agg="avg") * 100, 1), nsmall = 1)` , 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TAXI","ytd_yoy"))` from 
`r format(round(ytd_metric("VEHICLE_OCCUPANCY_RATE","TAXI", field="value", agg="avg", year_offset=-1) * 100, 1), nsmall = 1)` 
over the same period (January to `r prev_label`). 
`r trend_narrative("VEHICLE_OCCUPANCY_RATE","TAXI")`


The vehicle occupancy rate for TNS trips in `r end_label` was 
`r metric("VEHICLE_OCCUPANCY_RATE","TNS","last_value_fmt")`, 
compared with 
`r prev_metric("VEHICLE_OCCUPANCY_RATE","TNS")` 
in `r prev_month_label`, representing 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TNS","mom_last"))` month over month. 
`r shift_narrative("VEHICLE_OCCUPANCY_RATE","TNS")`

On a year-over-year basis, the vehicle occupancy rate for TNS trips in `r end_label` was 
`r metric("VEHICLE_OCCUPANCY_RATE","TNS","last_value_fmt")`, 
compared with 
`r prev_year_metric("VEHICLE_OCCUPANCY_RATE","TNS")` 
in `r prev_label`, representing 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TNS","yoy_last"))` year over year.

On a year-to-date basis, the average vehicle occupancy rate for TNS trips from January to `r end_label` was 
`r format(round(ytd_metric("VEHICLE_OCCUPANCY_RATE","TNS", field="value", agg="avg") * 100, 1), nsmall = 1)` , 
`r change_phrase(metric("VEHICLE_OCCUPANCY_RATE","TNS","ytd_yoy"))` from 
`r format(round(ytd_metric("VEHICLE_OCCUPANCY_RATE","TNS", field="value", agg="avg", year_offset=-1) * 100, 1), nsmall = 1)` 
over the same period (January to `r prev_label`). 
`r trend_narrative("VEHICLE_OCCUPANCY_RATE","TNS")`
