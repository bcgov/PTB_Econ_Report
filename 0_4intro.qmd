...
This economics report has been produced pursuant to a Board investigation under section 27 of the Act ([Policy Manual](https://www.ptboard.bc.ca/policy-manual)). The Board investigation was commenced on ([DATE to be inserted]), with respect to application #([Application number to be inserted]).
