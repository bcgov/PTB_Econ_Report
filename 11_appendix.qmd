...
Recall that this his indicator counts the number of distinct wheelchair-accessible vehicles (WAVs) that actively provided completed accessible trips during a given month. 
Let:
...
Regall that this indicator is defined as the duration (in minutes) between the time a trip was requested and when the passenger was picked up.
Let:
-   i: index for trips
