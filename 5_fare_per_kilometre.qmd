...
In `r region_name` Regional District, the fare per 5 km for Taxi trips in `r end_label` was 
`r metric("FARE_PER_5KM","TAXI","last_value_fmt")`, 
compared with 
`r prev_metric("FARE_PER_5KM","TAXI")` 
in `r prev_month_label`, representing 
`r change_phrase(metric("FARE_PER_5KM","TAXI","mom_last"))` month over month. 
`r shift_narrative("FARE_PER_5KM","TAXI")`

On a year-over-year basis, the fare per 5 km for Taxi trips in `r end_label` was 
`r metric("FARE_PER_5KM","TAXI","last_value_fmt")`, 
compared with 
`r prev_year_metric("FARE_PER_5KM","TAXI")` 
in `r prev_label`, representing 
`r change_phrase(metric("FARE_PER_5KM","TAXI","yoy_last"))` year over year.

On a year-to-date basis, the average fare per 5 km for Taxi trips from January to `r end_label` was 
`r format(round(ytd_metric("FARE_PER_5KM","TAXI", field="value", agg="avg"), 1), nsmall = 2)`, 
`r change_phrase(metric("FARE_PER_5KM","TAXI","ytd_yoy"))` from 
`r format(round(ytd_metric("FARE_PER_5KM","TAXI", field="value", agg="avg", year_offset=-1), 1), nsmall = 2)`
over the same period (January to `r prev_label`). 
`r trend_narrative("FARE_PER_5KM","TAXI")`[^6]
...
The fare per 5 km for TNS trips in `r end_label` was 
`r metric("FARE_PER_5KM","TNS","last_value_fmt")`, 
compared with 
`r prev_metric("FARE_PER_5KM","TNS")` 
in `r prev_month_label`, representing 
`r change_phrase(metric("FARE_PER_5KM","TNS","mom_last"))` month over month. 
`r shift_narrative("FARE_PER_5KM","TNS")`

On a year-over-year basis, the fare per 5 km for TNS trips in `r end_label` was 
`r metric("FARE_PER_5KM","TNS","last_value_fmt")`, 
compared with 
`r prev_year_metric("FARE_PER_5KM","TNS")` 
in `r prev_label`, representing 
`r change_phrase(metric("FARE_PER_5KM","TNS","yoy_last"))` year over year.

On a year-to-date basis, the average fare per 5 km for TNS trips from January to `r end_label` was 
`r format(round(ytd_metric("FARE_PER_5KM","TNS", field="value", agg="avg"), 1), nsmall = 2)`, 
`r change_phrase(metric("FARE_PER_5KM","TNS","ytd_yoy"))` from 
`r format(round(ytd_metric("FARE_PER_5KM","TNS", field="value", agg="avg", year_offset=-1), 1), nsmall = 2)` 
over the same period (January to `r prev_label`). 
`r trend_narrative("FARE_PER_5KM","TNS")`
