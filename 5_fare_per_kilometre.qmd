...
`r ytd_metric("FARE_PER_5KM","TAXI", field="value", agg="avg")`, 
`r change_phrase(metric("FARE_PER_5KM","TAXI","ytd_yoy"))` from 
`r ytd_metric("FARE_PER_5KM","TAXI", field="value", agg="avg", year_offset=-1)` 
...
`r ytd_metric("FARE_PER_5KM","TNS", field="value", agg="avg")`, 
`r change_phrase(metric("FARE_PER_5KM","TNS","ytd_yoy"))` from 
`r ytd_metric("FARE_PER_5KM","TNS", field="value", agg="avg", year_offset=-1)` 
over the same period (January to `r prev_label`). 
